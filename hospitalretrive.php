...
<td onclick="location.href='../html/enquiry.html'"align=center style="cursor:pointer;font:20px footlight MT light;background-color:cyan;">ENQUIRY</td>
...
{
	case"affordable":
	$result = mysqli_query($db , "SELECT * FROM addhospital WHERE facility='$facility'");
...
{ 
 ...
 echo'<table border="0" class="hslider" cellpadding="10"cellspacing="0"width=5 0% height=50% align=left>'.'<tr>'.'<td >'.
 '<table>'.'<tr>'.'<td>'.
 '<tr>'.'<td>'.'<b>'. "Hospital ID:".'</b>'."{$row['hosID']} <br>". '</tr>'.  
 '<tr>'.'<td>'.'<b>'. "Hospital Name:".'</b>'." {$row['hosname']}<br>".'</tr>'.
'<tr>'.'<td>'.'<b>'. "Location:".'</b>'." {$row['hoslocal']}<br>".'</tr>'.
'<tr>'.'<td>'.'<b>'. "specialisations available:".'</b>'." {$row['hosspecial']}<br>".'</tr>'.
 '<tr>'.'<td>'.'<b>'. "popular For:".'</b>'."{$row['popfor']}<br>".'</tr>'.
'<tr>'.'<td>'.'<b>'. "Facility:".'</b>'."{$row['facility']}<br>".'</tr>'.
'<tr>'.'<td>'.'<b>'. "DR search rating".'</b>'." {$row['drate']}<br>".'</tr>'.
 '<tr>'.'<td>'.'<b>'. "AVG.Patient Rating:".'</b>'." {$row['prate']}<br>".'</tr>'.
 '<tr>'.'<td>'.'<b>'. "Hospital Contact:".'</b>'." {$row['hcontact']}<br>".'</tr>'.
